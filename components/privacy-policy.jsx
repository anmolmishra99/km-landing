...
export function PrivacyPolicyComponent() {
  return (
    <div className="flex flex-col min-h-screen bg-green-50">
      <Navbar />
      <main className="max-w-7xl mx-auto flex-grow text-gray-900 px-4 py-8">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Krishi Mandi , the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Ekarigari Systems Private Limited ,
              172 B BLock Panki Kanpur.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>By email: info@krishimandi.in</li>
        </ul>
      </main>
      <Footer />
    </div>
